...
export const Hero = () => {
  ...
  const translateY = useTransform(scrollYProgress, [0, 1], [35, -300]);
        ...
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            ...
            <p className="text-xl text-[#010D3E] tracking-tight mt-6">
              Celebrate the joy of accomplishment with an app desogned to track 
          ...
          <div className = "mt-20 md:mt-0 md:h-[648px] md:flex-1 relative lg:left-40">
            <motion.img 
              src={Cog.src} 
